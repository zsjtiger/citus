...
DROP FUNCTION pg_catalog.create_time_partitions(regclass, timestamp with time zone, interval, timestamp with time zone);
DROP FUNCTION pg_catalog.get_missing_time_partition_ranges(regclass, timestamp with time zone, interval, timestamp with time zone);
